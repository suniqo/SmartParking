...
$\implies$ La cordenada en la posición  $1·n + k$ es $\bar{v_2} = (-j,  i )$  
$\implies$ La cordenada en la posición  $2·n + k$ es $\bar{v_3} = (-i, -j )$  
$\implies$ La cordenada en la posición  $3·n + k$ es $\bar{v_4} = ( j, -i )$  
